function Class_Phyxel_Enemy::Schedule_Cannon_Fire(%this)
{
...
if (%Object.class!$="Class_Phyxel_Player"){continue;}
...
class="Class_Projectile_Enemy";
CollisionCallback="true";
SceneLayer=15;

BlendColor="0.0 1.0 0.5 1.0";
...
%Sprite_Projectile.setCollisionGroups(0,26,30);
...
%this.Schedule_Cannon_Fire=schedule(%this.Module_ID_Parent.Int_Player_Cannon_Fire_Schedule_Interval*0.5,0,"Class_Phyxel_Enemy::Schedule_Cannon_Fire",%this);
